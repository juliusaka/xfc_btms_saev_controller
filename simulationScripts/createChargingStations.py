...
def createChargingStations(path_infrastructure, chargingStationClass: components.ChaDepParent, ResultWriter, SimBroker, btms_effiency = 0.85, create_only_this_id = None):
    ...
    for i in range(df_infrastructure.shape[0]):
        ...
        if create_only_this_id == None or ChargingStationId == create_only_this_id:

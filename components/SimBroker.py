...
class SimBroker:
    ...
    def __init__(self, path, dtype, t_Start):
    ...
    def step(self, timestep, ChargingStation):
        self.t_act      += timestep             # update actual time
        self.i          += 1
        i_old = self.i                          # first index row of slice, is the last index row from last time +1 
        ...
        ## TODO add here the vehicles to the chargingStation
        # generate vehicle
        # add vehicle
